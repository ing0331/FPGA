-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\DATA_MEMORY_block1.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterB/LineBuffer/DATA_MEMORY
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DATA_MEMORY_block1;


ARCHITECTURE rtl OF DATA_MEMORY_block1 IS

  -- Component Declarations
  COMPONENT PushPopCounterOne_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT PushPopCounter_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  FOR ALL : PushPopCounterOne_block1
    USE ENTITY work.PushPopCounterOne_block1(rtl);

  FOR ALL : SimpleDualPortRAM_generic
    USE ENTITY work.SimpleDualPortRAM_generic(rtl);

  FOR ALL : PushPopCounter_block1
    USE ENTITY work.PushPopCounter_block1(rtl);
...
BEGIN
  u_PushPopCounterOne : PushPopCounterOne_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter2 : PushPopCounter_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter3 : PushPopCounter_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter4 : PushPopCounter_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
