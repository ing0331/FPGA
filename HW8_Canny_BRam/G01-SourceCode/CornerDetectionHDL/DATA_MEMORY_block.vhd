-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\DATA_MEMORY_block.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/LineBuffer/DATA_MEMORY
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF DATA_MEMORY_block IS

  -- Component Declarations
  COMPONENT PushPopCounterOne_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT PushPopCounter_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  FOR ALL : PushPopCounterOne_block
    USE ENTITY work.PushPopCounterOne_block(rtl);

  FOR ALL : SimpleDualPortRAM_generic
    USE ENTITY work.SimpleDualPortRAM_generic(rtl);

  FOR ALL : PushPopCounter_block
    USE ENTITY work.PushPopCounter_block(rtl);
...
BEGIN
  u_PushPopCounterOne : PushPopCounterOne_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter2 : PushPopCounter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter3 : PushPopCounter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
  ...
  u_PushPopCounter4 : PushPopCounter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartIn,
