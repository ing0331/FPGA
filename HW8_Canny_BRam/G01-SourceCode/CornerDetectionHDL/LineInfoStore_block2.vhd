-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\LineInfoStore_block2.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/LineBuffer/LineInfoStore
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LineInfoStore_block2 IS
...
END LineInfoStore_block2;


ARCHITECTURE rtl OF LineInfoStore_block2 IS
  ...
  SIGNAL intdelay_reg_3                   : std_logic_vector(0 TO 1);  -- ufix1 [2]
...
BEGIN
  ...
  validFirstTap <= intdelay_reg_3(1);
