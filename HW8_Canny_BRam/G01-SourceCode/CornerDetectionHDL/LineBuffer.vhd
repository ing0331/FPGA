-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\LineBuffer.vhd
...
-- 
-- Module: LineBuffer
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/LineBuffer
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LineBuffer IS
  ...
  SIGNAL DataMemVector                    : vector_of_std_logic_vector8(0 TO 2);  -- ufix8 [3]
  ...
  SIGNAL constZero                        : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  ...
  SIGNAL DataMemVector_unsigned           : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL countEnHC_1                      : std_logic;
  SIGNAL horPadCount                      : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL DataMemVectorREG                 : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL DataMemVectorREG_1               : vector_of_std_logic_vector8(0 TO 2);  -- ufix8 [3]
  SIGNAL horPadCountREG                   : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL DataMemVectorPadded              : vector_of_std_logic_vector8(0 TO 2);  -- ufix8 [3]
  SIGNAL VerCountOut                      : std_logic_vector(10 DOWNTO 0);  -- ufix11
  SIGNAL verPadOut                        : vector_of_std_logic_vector8(0 TO 2);  -- ufix8 [3]
  SIGNAL verPadOut_unsigned               : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL verPadD                          : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL dataSigOut                       : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL dataSigPreOD                     : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
  SIGNAL dataOut_tmp                      : vector_of_unsigned8(0 TO 2);  -- uint8 [3]
...
BEGIN
  ...
  u_DATA_MEMORY : DATA_MEMORY
    PORT MAP( clk => clk,
              ...
              dataVectorOut => DataMemVector,  -- uint8 [3]
              popOut => popReg,
  ...
  u_Horizontal_Padder : Horizontal_Padder
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataVectorIn => DataMemVectorREG_1,  -- uint8 [3]
              horPadCount => std_logic_vector(horPadCountREG),  -- ufix11
              padShift => padShift,
              dataVector => DataMemVectorPadded  -- uint8 [3]
              );
  ...
  u_Vertical_Padder : Vertical_Padder
    PORT MAP( dataVectorIn => DataMemVectorPadded,  -- uint8 [3]
              verPadCount => VerCountOut,  -- ufix11
              dataVectorOut => verPadOut  -- uint8 [3]
              );
