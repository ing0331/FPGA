-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\GateProcessData_block.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/LineBuffer/GateProcessData
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY GateProcessData_block IS
...
END GateProcessData_block;


ARCHITECTURE rtl OF GateProcessData_block IS
