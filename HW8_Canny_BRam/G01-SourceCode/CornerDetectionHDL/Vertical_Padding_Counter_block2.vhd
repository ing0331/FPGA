-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\Vertical_Padding_Counter_block2.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterC/LineBuffer/Vertical 
-- Padding Counte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
...
ENTITY Vertical_Padding_Counter_block2 IS
...
END Vertical_Padding_Counter_block2;


ARCHITECTURE rtl OF Vertical_Padding_Counter_block2 IS
...
BEGIN
  ...
  prePad <= '1' WHEN VerticalPadCounter < to_unsigned(16#002#, 11) ELSE
      '0';
