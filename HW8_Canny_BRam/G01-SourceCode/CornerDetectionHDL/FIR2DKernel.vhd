-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\FIR2DKernel.vhd
...
-- 
-- Module: FIR2DKernel
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/FIR2DKernel
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF FIR2DKernel IS
  ...
  SIGNAL vStartOut_tap_latency_reg        : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL vStartIn_reg                     : std_logic;
  SIGNAL vStartIn_reg_vldSig              : std_logic;
  SIGNAL vStartOut_fir_latency_reg        : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL vEndOut_tap_latency_reg          : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL vEndIn_reg                       : std_logic;
  SIGNAL vEndIn_reg_vldSig                : std_logic;
  SIGNAL vEndOut_fir_latency_reg          : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL hStartOut_tap_latency_reg        : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL hStartIn_reg                     : std_logic;
  SIGNAL hStartIn_reg_vldSig              : std_logic;
  SIGNAL hStartOut_fir_latency_reg        : std_logic_vector(0 TO 12);  -- ufix1 [13]
  SIGNAL hEndOut_tap_latency_reg          : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL hEndIn_reg                       : std_logic;
  SIGNAL hEndIn_reg_vldSig                : std_logic;
  SIGNAL hEndOut_fir_latency_reg          : std_logic_vector(0 TO 12);  -- ufix1 [13]
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND processData = '1' THEN
        ...
        vStartOut_tap_latency_reg(1) <= vStartOut_tap_latency_reg(0);
      END IF;
    END IF;
  END PROCESS vStartOut_tap_latency_process;

  vStartIn_reg <= vStartOut_tap_latency_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        vStartOut_fir_latency_reg(1 TO 12) <= vStartOut_fir_latency_reg(0 TO 11);
      END IF;
    END IF;
  END PROCESS vStartOut_fir_latency_process;

  vStartOut <= vStartOut_fir_latency_reg(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND processData = '1' THEN
        ...
        vEndOut_tap_latency_reg(1) <= vEndOut_tap_latency_reg(0);
      END IF;
    END IF;
  END PROCESS vEndOut_tap_latency_process;

  vEndIn_reg <= vEndOut_tap_latency_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        vEndOut_fir_latency_reg(1 TO 12) <= vEndOut_fir_latency_reg(0 TO 11);
      END IF;
    END IF;
  END PROCESS vEndOut_fir_latency_process;

  vEndOut <= vEndOut_fir_latency_reg(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND processData = '1' THEN
        ...
        hStartOut_tap_latency_reg(1) <= hStartOut_tap_latency_reg(0);
      END IF;
    END IF;
  END PROCESS hStartOut_tap_latency_process;

  hStartIn_reg <= hStartOut_tap_latency_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        hStartOut_fir_latency_reg(1 TO 12) <= hStartOut_fir_latency_reg(0 TO 11);
      END IF;
    END IF;
  END PROCESS hStartOut_fir_latency_process;

  hStartOut <= hStartOut_fir_latency_reg(12);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' AND processData = '1' THEN
        ...
        hEndOut_tap_latency_reg(1) <= hEndOut_tap_latency_reg(0);
      END IF;
    END IF;
  END PROCESS hEndOut_tap_latency_process;

  hEndIn_reg <= hEndOut_tap_latency_reg(1);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        hEndOut_fir_latency_reg(1 TO 12) <= hEndOut_fir_latency_reg(0 TO 11);
      END IF;
    END IF;
  END PROCESS hEndOut_fir_latency_process;

  hEndOut <= hEndOut_fir_latency_reg(12);
