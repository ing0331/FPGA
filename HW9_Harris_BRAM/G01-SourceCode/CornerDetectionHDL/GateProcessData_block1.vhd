-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\GateProcessData_block1.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterB/LineBuffer/GateProcessData
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY GateProcessData_block1 IS
...
END GateProcessData_block1;


ARCHITECTURE rtl OF GateProcessData_block1 IS
