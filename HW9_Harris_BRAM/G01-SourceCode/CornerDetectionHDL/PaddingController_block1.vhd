-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\PaddingController_block1.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterB/LineBuffer/PaddingController
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY PaddingController_block1 IS
...
END PaddingController_block1;


ARCHITECTURE rtl OF PaddingController_block1 IS
...
BEGIN
  -- Padding Controller
  PaddingController_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS PaddingController_process;

  PaddingController_output : PROCESS (BlankingFlag, DumpingFlag, OnLineFlag, PaddingController_FSMState, PrePadFlag,
       alphaPostPadFlag)
  BEGIN
    ...
    CASE PaddingController_FSMState IS
      ...
      WHEN OTHERS => 
        ...
        PrePadding <= '0';
    END CASE;
  END PROCESS PaddingController_output;
