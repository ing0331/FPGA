-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\HarrisFilterB.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HarrisFilterB
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterB
-- Hierarchy Level: 3
-- 
-- Image Filter B
-- 
...
ARCHITECTURE rtl OF HarrisFilterB IS

  -- Component Declarations
  COMPONENT LineBuffer_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LineBuffer_block1
    USE ENTITY work.LineBuffer_block1(rtl);

  FOR ALL : FIR2DKernel_block
    USE ENTITY work.FIR2DKernel_block(rtl);
  ...
  SIGNAL BIn_signed                       : signed(19 DOWNTO 0);  -- sfix20
...
BEGIN
  u_LineBuffer : LineBuffer_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_imagekernel_inst : FIR2DKernel_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  filterBout <= std_logic_vector(dataOut);
