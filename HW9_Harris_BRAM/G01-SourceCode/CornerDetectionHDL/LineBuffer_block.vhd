-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\LineBuffer_block.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/LineBuffer
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LineBuffer_block IS
  ...
  COMPONENT InputControlValidation_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT LineSpaceAverager_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LineInfoStore_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT DataReadController_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT LineInfoStore_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStartIn                        :   IN    std_logic;
  ...
  COMPONENT PaddingController_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT GateProcessData_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Horizontal_Padder_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Vertical_Padding_Counter_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          frameEnd                        :   IN    std_logic;
  ...
  COMPONENT Vertical_Padder_block
  ...
  FOR ALL : InputControlValidation_block
    USE ENTITY work.InputControlValidation_block(rtl);

  FOR ALL : LineSpaceAverager_block
    USE ENTITY work.LineSpaceAverager_block(rtl);

  FOR ALL : DATA_MEMORY_block
    USE ENTITY work.DATA_MEMORY_block(rtl);

  FOR ALL : LineInfoStore_block1
    USE ENTITY work.LineInfoStore_block1(rtl);

  FOR ALL : DataReadController_block
    USE ENTITY work.DataReadController_block(rtl);

  FOR ALL : LineInfoStore_block2
    USE ENTITY work.LineInfoStore_block2(rtl);

  FOR ALL : PaddingController_block
    USE ENTITY work.PaddingController_block(rtl);

  FOR ALL : GateProcessData_block
    USE ENTITY work.GateProcessData_block(rtl);

  FOR ALL : Horizontal_Padder_block
    USE ENTITY work.Horizontal_Padder_block(rtl);

  FOR ALL : Vertical_Padding_Counter_block
    USE ENTITY work.Vertical_Padding_Counter_block(rtl);

  FOR ALL : Vertical_Padder_block
    USE ENTITY work.Vertical_Padder_block(rtl);
...
BEGIN
  u_INPUT_CONTROL_VALIDATION : InputControlValidation_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartInD,
  ...
  u_LineSpaceAverager : LineSpaceAverager_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DATA_MEMORY : DATA_MEMORY_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Unloading => unloading,
  ...
  u_LINE_INFO_STORE : LineInfoStore_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartDRC,
  ...
  u_DATA_READ_CONTROLLER : DataReadController_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartVREG,
  ...
  u_State_Transition_Flag_Gen : LineInfoStore_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStartIn => hStartDRC,
  ...
  u_Padding_Controller : PaddingController_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              PrePadFlag => PrePadFlag,
  ...
  u_Gate_Process_Data : GateProcessData_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Horizontal_Padder : Horizontal_Padder_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Vertical_Counter : Vertical_Padding_Counter_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              frameEnd => vStartIn,
  ...
  u_Vertical_Padder : Vertical_Padder_block
