-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\DataReadController_block1.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterB/LineBuffer/DataReadController
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DataReadController_block1 IS
...
END DataReadController_block1;


ARCHITECTURE rtl OF DataReadController_block1 IS
...
BEGIN
  ...
  DataReadController_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      END IF;
    END IF;
  END PROCESS DataReadController_process;

  DataReadController_output : PROCESS (AllEndOfLine, BlankCount_unsigned, DataReadController_FSMState,
  ...
  BEGIN
    ...
    CASE DataReadController_FSMState IS
      ...
      WHEN OTHERS => 
        ...
        Running <= '0';
    END CASE;
  END PROCESS DataReadController_output;
