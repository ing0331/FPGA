-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\RGB2INTENSITY.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/RGB2Bin/Color Space Converter/RGB2INTENSITY
-- Hierarchy Level: 3
-- 
...
ARCHITECTURE rtl OF RGB2INTENSITY IS
...
BEGIN
  ...
  multiInDelay1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  multiOutDelay1_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  multiInDelay2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  multiOutDelay2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  multiInDelay3_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  multiOutDelay3_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
