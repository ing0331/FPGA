-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\CornerDetectionHDL\LineSpaceAverager_block.vhd
...
-- Source Path: CornerDetectionHDL/HDL Corner Algorithm/Corner Detector/HarrisCore/HarrisFilterA/LineBuffer/LineSpaceAverager
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LineSpaceAverager_block IS
...
END LineSpaceAverager_block;


ARCHITECTURE rtl OF LineSpaceAverager_block IS
